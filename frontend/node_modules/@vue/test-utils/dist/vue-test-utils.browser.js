    ...
    ***************************************************************************** */
    ...
    var recordEvent = function (vm, event, args) {
        ...
        if (event.startsWith('update:')) {
            if (args.length !== 1) {
                throw new Error('Two-way bound properties have to emit a single value. ' +
                    args.length +
                    ' values given.');
            }
    ...
    var VueWrapper = /** @class */ (function (_super) {
        ...
        VueWrapper.prototype.attachNativeEventListener = function () {
            ...
            for (var _i = 0, _a = Object.keys(domEventTypes); _i < _a.length; _i++) {
                var eventName = _a[_i];
                _loop_1(eventName);
            }
        };
    ...
    function mount(originalComponent, options) {
        ...
        stubComponents(global.stubs, global.renderStubDefaultSlot ? false : options === null || options === void 0 ? void 0 : options.shallow);
